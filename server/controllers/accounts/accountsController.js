...
//create
const createAcctCtrl =  async(req, res, next)=>{
    ...
    try {
        ...
        //push account into users accounts field
...
//get single account
const fetchAcctCtrl = async(req, res, next)=>{
    try {
...
//delete
const deleteAcctCtrl = async(req, res, next)=>{
    try {
        const { id } = req.params;
...
//update
const updateAcctCtrl = async(req, res, next)=>{
    try {
        const { id } = req.params;
